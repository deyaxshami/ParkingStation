...
### لقطات شاشة لوحة التحكم

تعرض النظرة العامة التالية لوحة التحكم قبل إنشاء الاتصال التسلسلي. تظهر أماكن العتاد `A12` و `A41` في البداية بحالة غير معروفة حتى يتم طلب الحالة الحالية.

![نظرة عامة على لوحة تحكم Parking Station](Assets/DashboardOverview.png)

| زر الاتصال | اختيار المنفذ التسلسلي |
| --- | --- |
| ![زر Connect في لوحة تحكم الويب](Assets/DashboardConnectButton.png) | ![مربع حوار المتصفح لاختيار المنفذ التسلسلي](Assets/SerialPortSelectionDialog.png) |
| اضغط `Connect` لفتح اختيار أجهزة Web Serial في المتصفح. | اختر ST-LINK Virtual COM Port. إذا لم يظهر جهاز متوافق، فتحقق من اتصال USB ومن عدم استخدام برنامج آخر للمنفذ. |
...
### مشروع مدرسي فقط وغير مناسب للتشغيل في العالم الحقيقي

محطة الوقوف هذه هي مشروع مدرسي وعرض توضيحي فقط. توضح التفاعل الأساسي بين الحساسات والبرنامج الثابت والاتصال التسلسلي وواجهة الويب، لكنها ليست منتجا معتمدا أو متينا بما يكفي للاستخدام في موقف سيارات عام أو تجاري حقيقي. يجب أن يبقى النظام الحقيقي موثوقا مع تغير الطقس، وأن يكتشف الأعطال تلقائيا، ويتحمل حركة المرور والتخريب، ويحمي اتصالاته، ويستمر بشكل آمن عند تعطل أحد المكونات.

#### حالات فشل محتملة في العالم الحقيقي

- يمكن أن تظهر ورقة شجر أو ورقة عادية أو نفايات أو أي جسم فوق الحساس على أنها مركبة متوقفة.
- يمكن للمطر أو البرك أو التكاثف أو الطين أو الثلج أو الجليد تغطية الحساس أو تغيير انعكاس الأشعة تحت الحمراء أو التسبب في تآكل أو عطل كهربائي.
- قد يؤدي شخص يقف في المكان ويتحدث مع صديقه، أو دراجة، أو عربة تسوق، أو حيوان، أو جسم آخر غير السيارة إلى حالة إشغال خاطئة.
- قد لا تعكس الأسطح السوداء أو غير اللامعة أو المتسخة أو ضعيفة الانعكاس ضوءا كافيا، فيظهر المكان المشغول على أنه فارغ.
- يمكن لضوء الشمس المباشر والمصابيح الأمامية والظلال وتغير الإضاءة المحيطة التشويش على قياسات الأشعة تحت الحمراء.
- قد لا تغطي المركبات ذات الخلوص الأرضي المرتفع أو الشكل غير المعتاد أو وضع الوقوف غير المناسب الحساس بشكل صحيح.
- قد تؤدي مركبة مجاورة أو جزء بارز منها إلى تشغيل حساس المكان الخطأ.
- يمكن أن تتضرر الأسلاك والمكونات المكشوفة بسبب الرطوبة أو المرور أو معدات التنظيف أو التخريب أو اللمس العرضي.
- يمكن أن تتعطل الطاقة أو USB أو الاتصال التسلسلي أو المتصفح أو المتحكم. لا يملك النموذج الأولي إبلاغا تلقائيا عن الأعطال أو تكرارا احتياطيا أو مراقبة عن بعد أو استراتيجية استعادة موثوقة.
- لوحة Web Serial المحلية مناسبة للعرض، لكنها ليست منصة إدارة قابلة للتوسع أو مؤمنة أو عالية التوفر.

#### حلول أفضل لمواقف السيارات الحقيقية

| الحل | المزايا | العيوب ومدى الواقعية |
| --- | --- | --- |
| حساس أرضي مقاوم للطقس يجمع بين مقياس المغناطيسية والرادار | يكتشف دمج الحساسات التأثير المغناطيسي والوجود الفعلي للمركبة؛ تأثير الأوراق والأشخاص والإضاءة أقل | حل خارجي واقعي ومتين، لكن أعمال الرصف والتركيب المقاوم للماء واستبدال البطارية والمعايرة والصيانة تزيد التكلفة |
| حساس وزن أو ضغط مع حساس IR | يمكن لحد وزن مناسب تمييز كثير من المركبات عن الأوراق أو الأشخاص، بينما يوفر IR قياسا ثانيا | ممكن تقنيا، لكن تركيبه داخل الطريق مكلف؛ وتبقى مشاكل تصريف المياه والصقيع والتآكل والأحمال الثقيلة والدراجات النارية والمعايرة |
| حساسات فوقية بالموجات فوق الصوتية أو الرادار | تركيب محمي وكشف جيد لكل مكان، خاصة في مرائب السيارات | واقعي عند توفر سقف أو هيكل داعم؛ أقل عملية في المواقف المفتوحة ويحتاج أيضا إلى طاقة وشبكة وصيانة |
| نظام كاميرات بالذكاء الاصطناعي | يمكن لكاميرا واحدة مراقبة عدة أماكن وتمييز المركبات عن كثير من الأجسام الأخرى | قد يكون اقتصاديا لعدد كبير من الأماكن، لكنه يتأثر بالحجب والظلام والطقس واتساخ العدسات وأخطاء النموذج؛ كما يفرض متطلبات كبيرة للخصوصية والأمن السيبراني |

بالنسبة إلى تركيب خارجي حقيقي صغير، يكون حساس أرضي صناعي مصنف ضد الظروف الجوية ويجمع بين مقياس المغناطيسية والرادار أكثر واقعية عادة من نموذج IR المكشوف. يجب ربطه بنظام خلفي مراقب وأن يدعم مراقبة البطارية وفحص الاتصال وحالات الأعطال والتحديثات الآمنة والصيانة الدورية. يمكن أن تكون كاميرا الذكاء الاصطناعي مفيدة عند تغطية أماكن كثيرة، لكن يفضل أن تعالج حالة الإشغال محليا، وتتجنب التعرف على الأشخاص، ولا تخزن الصور إلا عند الضرورة ومع وجود أساس قانوني.

#### التقييم المالي والقانوني والتشغيلي

- لا تمثل القطع الرخيصة في هذا النموذج التكلفة الرئيسية لنظام حقيقي. قد تكلف أعمال البناء والحاويات المقاومة للطقس والتركيب والطاقة والشبكة وبرنامج الخادم والمعايرة والفحص والإصلاح والصيانة طويلة الأجل أكثر بكثير من الحساسات نفسها.
- يحسن دمج الحساسات الموثوقية، لكنه يزيد سعر العتاد واستهلاك الطاقة وتعقيد البرمجيات وجهد الصيانة. وحتى النظام الاحترافي يحتاج إلى اختبارات ميدانية وقياس الدقة قبل التشغيل.
- قد تقلل أنظمة الكاميرات عدد الأجهزة لكل مكان، لكنها تحتاج إلى تخطيط دقيق لزوايا الرؤية والإضاءة وأمن البيانات وصلاحيات الوصول والتحقق المستمر من النموذج.
- في ألمانيا والاتحاد الأوروبي، قد تكون صور الأشخاص أو لوحات المركبات بيانات شخصية. كشف مواقف السيارات بالفيديو ليس ممنوعا تلقائيا، لكنه يحتاج إلى غرض قانوني وضرورة وتناسب وشفافية وتقليل البيانات ومعالجة آمنة وسياسة حذف مناسبة. توفر [نظرة المفوضية الأوروبية لحماية البيانات](https://commission.europa.eu/law/law-topic/data-protection_en) و[إرشادات مجلس حماية البيانات الأوروبي بشأن أجهزة الفيديو](https://www.edpb.europa.eu/sites/default/files/files/file1/edpb_guidelines_201903_video_devices_en_0.pdf) معلومات مهمة.
- قد يتطلب التركيب في الطرق العامة أو مواقف السيارات المشتركة أيضا إذنا من المالك أو الجهة المختصة، وأعمالا كهربائية مطابقة، وموافقة بناء، ومراعاة إمكانية الوصول، وتحديد المسؤولية عن معلومات الإشغال الخاطئة.

### تعطل الحساس واستبداله أثناء الاختبار

أثناء الاختبار، تضرر الحساس الأيمن الخاص بمكان الوقوف `A41` بسبب قصر كهربائي وتوقف عن العمل. تم استبداله بوحدة [حساس IR لاكتشاف العوائق من AZ-Delivery](https://www.az-delivery.de/en/products/ir-abstand-sensor-modul). تستخدم الوحدة البديلة مقارن LM393، ويمكن ضبطها باستخدام مقياس الجهد الموجود عليها، وتدعم جهد تشغيل من 3.3 V إلى 5 V.

أثناء اختبارات المشروع، لم يتمكن الحساس البديل من اكتشاف الأقمشة السوداء بشكل موثوق. يمكن للمواد الداكنة امتصاص جزء كبير من ضوء الأشعة تحت الحمراء المرسل بدلا من عكسه إلى المستقبل. لذلك قد يظهر مكان الوقوف الأيمن بشكل خاطئ على أنه فارغ عندما يغطي الحساس قماش أسود أو سطح داكن ضعيف الانعكاس. هذا قيد معروف في النموذج الأولي الحالي ويجب مراعاته أثناء العروض والاختبارات.
...
| --- | --- | --- |
| ![منظر داخلي مع مكانين للوقوف](Assets/ParkingModelInterior.jpeg) | منظر داخلي لنموذج الكرتون مع مكانين منفصلين | يوضح البناء الميكانيكي وموضع مساحات الوقوف |
| ![منظر خارجي لهيكل النموذج](Assets/ParkingModelExterior.jpeg) | منظر خارجي لهيكل النموذج | يوثق الهيكل النهائي المصنوع من الكرتون |
| ![الجهة الخلفية مع NUCLEO والتوصيلات](Assets/NucleoWiringRearView.jpeg) | الجهة الخلفية مع لوحة NUCLEO وأسلاك jumper | يبين أن الإلكترونيات موصولة بالنموذج |
| ![منظر جانبي مع الأسلاك](Assets/CableRoutingSideView.jpeg) | منظر جانبي لمسار الأسلاك | يساعد على تتبع التوصيل من اللوحة إلى الحساسات و LEDs |
| ![منظر الهيكل](Assets/ParkingModelHousing.jpeg) | منظر خارجي للهيكل | يوثق الثبات والشكل وطريقة بناء النموذج |
| ![منظر داخلي مع كلا LEDين الأخضرين](Assets/GreenAvailabilityLeds.jpeg) | منظر داخلي مع كلا LEDي التوفر الأخضرين | يعرض الإشارة العتادية المباشرة للأماكن الفارغة |
| ![Breadboard وتوصيل اللوحة](Assets/BreadboardNucleoWiring.jpeg) | Breadboard ومنطقة NUCLEO وأسلاك التوصيل | يعمل كدليل على تركيب الاختبار الكهربائي |
| ![وظيفة LED ظاهرة](Assets/GreenAvailabilityLed.jpeg) | LED أخضر مضاء داخل مكان الوقوف | يوضح الوظيفة: المكان الفارغ يشار إليه بضوء أخضر |
| ![مكان وقوف مع سيارة نموذجية](Assets/ModelCarSensorTest.jpeg) | مكان وقوف مع سيارة نموذجية ضمن مجال الحساس | يعرض النتيجة النهائية في حالة اختبار واقعية |
| ![نموذج موقف السيارات مع الحساس الأيمن الجديد](Assets/ParkingModelWithReplacementSensor.jpeg) | منظر داخلي للنموذج بعد تركيب الحساس البديل في مكان الوقوف الأيمن | يوثق التركيب المعدل بعد تلف الحساس الأصلي أثناء الاختبار |
| ![صورة مقربة لحساس IR الجديد](Assets/ReplacementIrSensor.jpeg) | صورة مقربة لوحدة حساس IR الجديدة لاكتشاف العوائق من AZ-Delivery | تعرض الحساس البديل ومكونات الأشعة تحت الحمراء ومقياس الجهد القابل للضبط |
...
#### لماذا تم استخدام STM32 بدلا من Arduino

كانت الخطة الأصلية تنفيذ المشروع باستخدام Arduino. قبل موعد التسليم بأسبوع واحد، تم طلب لوحة Arduino والحساسات المطلوبة. كان من المفترض أن تصل الشحنة خلال يومين، وهو ما كان سيوفر عادة وقتا كافيا للتركيب والبرمجة والاختبار. لكن الشحنة تأخرت بشكل كبير، ولم تكن المكونات المطلوبة قد وصلت حتى اليوم السابق للتسليم.

ولأن المشروع كان يجب تسليمه في صباح اليوم التالي، تم استعارة لوحة تطوير STM32 وحساسي IR من شركة `3P-Services`. سمح ذلك بمتابعة المشروع في وقت قصير، لكنه غير المتطلبات التقنية بشكل واضح. مقارنة بحل Arduino المخطط له أصلا، تطلب STM32 قدرا أكبر بكثير من الإعداد والعمل القريب من العتاد دفعة واحدة. كان من الضروري فهم وضبط توزيع الأرجل وأوضاع GPIO وإعداد الساعة واتصال UART والمقاطعات وبنية البرنامج الثابت ونظام البناء ودمج تعريفات STM32 HAL/BSP تحت ضغط زمني كبير.

لم تتم إعادة كتابة تعريفات STM32 المولدة بالكامل من الصفر، لكنها احتاجت إلى الاختيار والدمج والضبط والربط الصحيح مع البرنامج الثابت الخاص بالمشروع. كان هذا عبء عمل أكبر بكثير من المتوقع قبل التسليم مباشرة. وفي الوقت نفسه، أدى استخدام STM32 إلى فهم أعمق لتهيئة المتحكمات وطبقات تجريد العتاد والاتصال التسلسلي والمقاطعات وأنظمة بناء البرمجيات المضمنة، مقارنة بما كان سيتطلبه تنفيذ أبسط باستخدام Arduino.
