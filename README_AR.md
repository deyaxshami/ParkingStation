...
![نظرة عامة على لوحة تحكم Parking Station](Assets/WebSiteOverView.png)

| زر الاتصال | اختيار المنفذ التسلسلي |
| --- | --- |
| ![زر Connect في لوحة تحكم الويب](Assets/ConnectButton.png) | ![مربع حوار المتصفح لاختيار المنفذ التسلسلي](Assets/ChooseSerailPort.png) |
...
| ![نموذج موقف السيارات مع الحساس الأيمن الجديد](Assets/BoxWithNewSensor.jpeg) | منظر داخلي للنموذج بعد تركيب الحساس البديل في مكان الوقوف الأيمن | يوثق التركيب المعدل بعد تلف الحساس الأصلي أثناء الاختبار |
| ![صورة مقربة لحساس IR الجديد](Assets/NewSensor.jpeg) | صورة مقربة لوحدة حساس IR الجديدة لاكتشاف العوائق من AZ-Delivery | تعرض الحساس البديل ومكونات الأشعة تحت الحمراء ومقياس الجهد القابل للضبط |
